        ...
        if not overlap_aas:
            ...
            for aa in overlap_aas:
                ...
                for species, sp_aa in species2aa.items():
                    if sp_aa == aa:
                        # Check if this species is in FG or BG for the specific trait
                        if species in multiconfig.s2t and trait:
                            trait_fg = trait + "_1"
                            trait_bg = trait + "_0"
                            if trait_fg in multiconfig.s2t[species]:
                                fg_species_with_aa.append(species)
                            elif trait_bg in multiconfig.s2t[species]:
